...
import com.vst.recyclerviewlib.base.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public MultiItemTypeAdapter<T> refresh(Collection<T> datas) {
        if (mDatas != null && !mDatas.isEmpty()) {
            //去重
            for (T data : datas) {
                if (!mDatas.contains(data)) mDatas.add(data);
            }
        } else {
            if (datas == null) {
                return this;
